...
-- user2_DB라은 이름으로 tableSpace를 생성을 하고
-- 실제 데이터가 저장되는 곳은 /bizwork/oracle/data/ 폴더에
--      user2.dbf 라는 파일로 생성을 하라
-- 초기 크기는 10MByte로 하고 용량이 부족하면 10KByte씩 용량을 확장 하라
...
-- 11gXE 환경에서는 외부접속으로 인한 보안 문제가 크기 않으므로
